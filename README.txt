...
подразумевается, но не упоминается
    ...
    моё
        - почистить код
        - протестировать всё многопоточное на многопоточность
        - зачем вообще нужен класс Optional
        - добавить валидацию на отрицательное
        - проверить надобность в Exception-ах в Cart-сервлетах